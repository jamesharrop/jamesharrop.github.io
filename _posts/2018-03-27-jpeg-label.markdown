---
layout: post
title: "JPEG label - A Python script to rename JPEG files according to the date in their EXIF data"
categories: python
---
...
## Code
[Link to GitHub repository](https://github.com/jamesharrop/jpeglabel)

```swift
#!/usr/bin/env python
#####################################
# JpegLabel. 27th March 2018
#####################################
