---
layout: post
title: "Linear algebra in Swift: a matrix struct data type"
...
[Linear algebra in Swift: a matrix struct data type - link to GitHub repo](https://github.com/jamesharrop/linear-algebra).
